...
import com.cmw.android.widgets.examples.HandlerActivity;
import com.cmw.android.widgets.examples.HandlerThreadActivity;
...
public class TreeDataProvider implements DataProvider{
	...
	private void initDataSource(){
        ...
        TreeElement fisrtelement4 = new TreeElement("04", "常用类示例");  
        nodes.add(fisrtelement1);  
        nodes.add(fisrtelement2);  
        nodes.add(fisrtelement3);
        nodes.add(fisrtelement4);
        ...
        fisrtelement4.addChild(secondelement4_1);
        fisrtelement4.addChild(secondelement4_2);
	}
